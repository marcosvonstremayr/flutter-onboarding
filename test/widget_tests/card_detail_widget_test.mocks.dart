...
import 'package:hearthstone_cards/src/config/notification_service/local_notification_service.dart'
    as _i5;
import 'package:hearthstone_cards/src/data/model/card_model.dart' as _i8;
import 'package:hearthstone_cards/src/domain/entity/card_event.dart' as _i7;
import 'package:hearthstone_cards/src/presentation/bloc/blocs.dart' as _i9;
...
class MockFavoritesBloc extends _i1.Mock implements _i3.FavoritesBloc {
  ...
  @override
  _i6.Future<void> saveFavoriteCard(_i8.CardModel? card) => (super.noSuchMethod(
      Invocation.method(#saveFavoriteCard, [card]),
      returnValue: _i6.Future<void>.value(),
      returnValueForMissingStub: _i6.Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> isCardFavorite(_i8.CardModel? card) => (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBlocs extends _i1.Mock implements _i9.Blocs {
  MockBlocs() {
    _i1.throwOnMissingStub(this);
  }
